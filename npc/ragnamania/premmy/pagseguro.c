...
// Vers�es:
// 1.0 - Vers�o inicial.
// 1.1 - Adicionada configura��o de bonus de doa��o e nome do servidor.
//
//	OBS: Anexado ao fim do NPC a tabela de log necess�ria, instale no seu
//	banco de dados caso a tabela n�o exista.
//
// ======================================================================
...
// CONFIGURA��ES
OnInit:
	set .promo,50000;						// Promo��o ativa para doa��es de 50.000 cash ou mais. 0 = Desativado.
...
/*			  ANEXO - Tabela de LOG
 *	Instale caso n�o tenha no seu banco de dados.
 *
 *	Tabela:
 *
