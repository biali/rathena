	...
	switch(select("Save Respawn Point:Open Storage:Open Guild Storage:Teleport Services:Healing Services:Rentals") ) {
		...
		case 4: // Teleport
			...
			menu	(#AQ_LastWeek==getvariableofnpc(.Week,"adventurer_quest")?"Abyss Lakes":":"),D1,
					...
					"Coal Mines",D10, 
					"Culvert",D11, 
					(#AQ_LastWeek==getvariableofnpc(.Month,"adventurer_quest")?"Cursed Abbey":":"),D12, 
					// "Dewata Dungeon",D13,
					...
					(#AQ_LastMonth==getvariableofnpc(.Month,"adventurer_quest")?"Kiel Dungeon":":"),D22,
					// "Kiel Dungeon",D22, 
					"Louyang Dungeon",D23,
					"Magma Dungeon",D24, 
					...
					"Payon Dungeon",D30, 
					"Pyramids",D31, 
					(#AQ_LastMonth==getvariableofnpc(.Month,"adventurer_quest")?"Rachel Sanctuary":":"),D32,
					// "Scaraba Hole",D33, 
					"Sphinx",D34, 
					"Sunken Ship",D35, 
