...
geffen,100,72,4	script	Geferus	735,{
	...
	case 1:
		...
		switch(select("^0000FFWraith Dead^000000:^0000FFMini Deamon^000000:^0000FFZombie Master^000000:^0000FFGhoul^000000:^0000FFDeviruchi^000000")) {
			case 1: callsub L_Quest,64181,"Wraith Dead",1551150,"���̽�����ī��","Find it in ^8B4513Geffen Guild Dungeons^000000.",542700;
			case 2: callsub L_Quest,64182,"Mini Deamon",1259400,"�̴ϵ���ī��","Find it in ^8B4513Geffen Guild Dungeons^000000.",558300;
			case 3: callsub L_Quest,64183,"Zombie Master",1141500,"���񸶽���ī��","Find it in ^8B4513Geffen Guild Dungeons^000000.",423900;
			case 4: callsub L_Quest,64184,"Ghoul",326400,"����ī��","Find it in ^8B4513Geffen Guild Dungeons^000000.",186600;
			case 5: callsub L_Quest,64185,"Deviruchi",798600,"�����ġī��","Find it in ^8B4513Geffen Guild Dungeons^000000.",383700;
		}
	}
	end;
