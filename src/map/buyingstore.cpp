...
#ifdef BGEXTENDED
	//if (sd->inventory.u.items_inventory[index].card[0] == CARD0_CREATE && ((MakeDWord(sd->inventory.u.items_inventory[index].card[2], sd->inventory.u.items_inventory[index].card[3])) == (battle_config.bg_reserved_char_id || battle_config.woe_reserved_char_id || battle_config.pvp_reserved_char_id || battle_config.ancient_reserved_char_id || battle_config.rpk_reserved_char_id || battle_config.fvf_reserved_char_id) && !battle_config.bg_can_trade ))
	if (sd->inventory.u.items_inventory[index].card[0] == CARD0_CREATE && ((MakeDWord(sd->inventory.u.items_inventory[index].card[2], sd->inventory.u.items_inventory[index].card[3])) > battle_config.rpk_reserved_char_id && !battle_config.bg_can_trade ))
