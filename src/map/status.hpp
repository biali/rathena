...
enum sc_type : int16 {
	...
	**/
	...
	SC_MOUNT_CD, // biali mount rework
...
/// @APIHOOK_END
	...
	EFST_IMUNITY = 2000, //Biali black zone
	EFST_IMUNITY_CD, //Biali black zone
	EFST_KNOCKED, //Biali Black zone

	EFST_MOUNT_CD, //Biali Mount Rework
